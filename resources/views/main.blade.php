  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="cont-main">
        ...
        <center><p id = "name1" class="cont-text" style="margin-top: 10px min-height: 55px"></p></center>
        <div>
    ...
    <div class="col-md-4">
      <div class="cont-main">
        ...
        <center><p id = "name2" class="cont-text" style="margin-top: 10px min-height: 55px"></p></center>
        <div>
    ...
    <div class="col-md-4">
      <div class="cont-main">
        ...
        <center><p id = "name3" class="cont-text" style="margin-top: 10px min-height: 55px"></p></center>
        <div>
